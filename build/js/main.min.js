...
var _toggle = require("./modules/menu/toggle");
var _slider = require("./modules/hero/slider");
var _video = require("./modules/hero/video");
var _audio = require("./modules/hero/audio");
var _slider2 = require("./modules/tours/slider");
var _slider3 = require("./modules/coaches/slider");
var _slider4 = require("./modules/reviews/slider");
var _slider5 = require("./modules/advantages/slider");
var _slider6 = require("./modules/gallery/slider");
var _map = require("./modules/contacts/map2");
var _indent = require("./modules/hero/indent");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  (0, _audio.addAudioPlayer)();
  (0, _slider.addHeroSlider)();
  ...
  window.addEventListener('load', function () {
    ...
    (0, _slider2.addToursSlider)();
    (0, _slider3.addInstructorsSlider)();
    (0, _slider4.addReviewsSlider)();
    (0, _slider5.addAdvantagesSlider)();
    (0, _slider6.addGallerySlider)();
...
},{"./modules/advantages/slider":2,"./modules/coaches/slider":3,"./modules/contacts/map2":4,"./modules/form-validate/form":6,"./modules/gallery/slider":12,"./modules/hero/audio":13,"./modules/hero/indent":14,"./modules/hero/slider":15,"./modules/hero/video":16,"./modules/menu/toggle":17,"./modules/reviews/slider":18,"./modules/tours/slider":19,"./utils/ios-vh-fix":21,"./utils/scroll-lock":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addAdvantagesSlider = void 0;
...
var addAdvantagesSlider = function addAdvantagesSlider() {
  var swiper = null;
...
exports.addAdvantagesSlider = addAdvantagesSlider;

},{"../../utils/is-mobile":22,"../../vendor/swiper":25}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addInstructorsSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addInstructorsSlider = function addInstructorsSlider() {
  if (document.querySelector('.coaches__slider')) {
    return new _swiper.default('.coaches__slider', {
      allowTouchMove: (0, _isMobile.isMobile)(),
      spaceBetween: 30,
      breakpoints: {
        0: {
...
exports.addInstructorsSlider = addInstructorsSlider;

},{"../../utils/is-mobile":22,"../../vendor/swiper":25}],4:[function(require,module,exports){
"use strict";
...
exports.addGallerySlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addGallerySlider = function addGallerySlider() {
  if (document.querySelector('.gallery__slider')) {
    return new _swiper.default('.gallery__slider', {
      allowTouchMove: (0, _isMobile.isMobile)(),
      slidesPerView: 'auto',
      navigation: {
...
exports.addGallerySlider = addGallerySlider;

},{"../../utils/is-mobile":22,"../../vendor/swiper":25}],13:[function(require,module,exports){
"use strict";
...
var addAudioPlayer = function addAudioPlayer() {
  if (document.querySelector('.audio')) {
    var root = document.querySelector('.audio');
    var button = document.getElementById('audio__play');
    var iframe = "\n    <iframe seamless id='iframe' frameborder=\"0\" style=\"border:none;width:340px;height:220px;\" width=\"340\" height=\"220\" src=\"".concat(button.dataset.src, "?autoplay=0\">\u0421\u043B\u0443\u0448\u0430\u0439\u0442\u0435 <a href='").concat(button.dataset.src, "'>\u041F\u0440\u043E \u043A\u043E\u0434</a> \u043D\u0430 \u042F\u043D\u0434\u0435\u043A\u0441 \u041C\u0443\u0437\u044B\u043A\u0435</iframe>\n  ");
  ...
  if (document.querySelector('.hero__slider')) {
    ...
    swiper.on('slideChange', function () {
      ...
      if (document.getElementById('iframe')) {
        var app = document.getElementById('iframe');
...
},{"../../utils/is-mobile":22,"../../vendor/swiper":25}],16:[function(require,module,exports){
"use strict";
...
var addVideoPlayer = function addVideoPlayer() {
  if (document.querySelector('.video')) {
    ...
    var iframe = "\n  <iframe id='iframe' width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/".concat(button.dataset.src, "?autoplay=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>\n  ");
    button.addEventListener('click', function () {
      root.innerHTML = iframe;
    }, {
      once: true
...
},{"../../utils/is-mobile":22,"../../vendor/swiper":25}],19:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addToursSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var addToursSlider = function addToursSlider() {
  if (document.querySelector('.tours__slider')) {
    return new _swiper.default('.tours__slider', {
      allowTouchMove: (0, _isMobile.isMobile)(),
      breakpoints: {
        0: {
          centeredSlides: true,
...
exports.addToursSlider = addToursSlider;

},{"../../utils/is-mobile":22,"../../vendor/swiper":25}],20:[function(require,module,exports){
"use strict";
